...
export const Testimonial = () => {
  ...
  return (
    <section className="section-testimonial" ref={sectionRef}>
              ...
              <div className="text">
                <div className="ct ct-1 active">
                  ...
                  <div className="content">
                    KHOÁ học quá tuyệt vời, đầy đủ kiến thức lại còn được bonus thêm những kỹ năng
                ...
                <div className="ct ct-2">
                  ...
                  <div className="content">
                    ...
                    KHOÁ học. Nơi chọn lựa an tâm cho mọi người.
                  </div>
                  <div className="bottom">
                    <a href="#" target="_blank">
                      <img src="img/facebook.svg" alt="" />
